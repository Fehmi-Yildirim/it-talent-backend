...
export class CompaniesService {
  ...
  async create(userId: string, dto: CreateCompanyDto) {
    ...
    if (recruiter.companyId) {
      throw new ConflictException('Recruiter is already assigned to a company');
    }
  ...
  async getMyCompany(userId: string) {
    ...
    if (!recruiter) {
      throw new ForbiddenException('Only recruiters can access a company');
    }

    if (!recruiter.company) {
      throw new NotFoundException('Recruiter is not assigned to a company');
    }
  ...
  async updateMyCompany(userId: string, dto: UpdateCompanyDto) {
    ...
    if (!recruiter) {
      throw new ForbiddenException('Only recruiters can update a company');
    }
